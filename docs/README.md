...
| [Code signing](signing.md) | What the release signs on Windows and what it does not, why SignPath Foundation, and every step the maintainer has to take to get a certificate |
