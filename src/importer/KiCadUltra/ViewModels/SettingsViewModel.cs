...
public partial class SettingsViewModel : ObservableObject
{
    ...
    public string McpExecutablePath
    {
        get
        {
            ...
            {
                return Environment.ProcessPath ?? "KiCadUltra.exe";
            }
        }
    }
