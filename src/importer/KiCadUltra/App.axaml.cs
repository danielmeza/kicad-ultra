    ...
    public override void OnFrameworkInitializationCompleted()
    {
        if (ApplicationLifetime is IClassicDesktopStyleApplicationLifetime desktop)
        {
            ...
            if (_serviceProvider != null)
            {
                ...
                // AppDataFolder names it: until #132 the browser cache sat under a second
                // application-data folder of its own, and Program.Main has already moved it here.
                var browserPath = AppDataFolder.BrowserCache;
