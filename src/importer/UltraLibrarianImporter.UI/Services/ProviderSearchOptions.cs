...
/// </summary>
/// <remarks>
/// No provider publishes a per-second limit today: jlcsearch documents none, and Nexar's quota is
/// monthly, which the cache protects far better than any spacing could. The defaults are therefore
/// modest rather than derived from a contract. When a provider with a published limit arrives
/// (#51), give it its own bucket instead of lowering these for everyone.
/// </remarks>
