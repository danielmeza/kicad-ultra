...
public partial class MainViewModel : ObservableObject
{
    ...
    private async Task ImportComponent()
    {
        ...
        try
        {
            ...
            ImportResult result = await _importer.ImportComponentAsync(_downloadedFilePath, SelectedImportType);
    ...
    {
        StatusMessage =
            $"Downloading library: {Path.GetFileName(fullPath)} {percentComplete}% " +
